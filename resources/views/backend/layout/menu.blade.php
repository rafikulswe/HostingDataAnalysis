    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html"><img src="{{ asset('public/backend/assets/images/logo_light.png') }}"
                    alt=""></a>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown language-switch">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('public/backend/assets/images/flags/gb.png') }}" class="position-left" alt="">
                        English
                        <span class="caret"></span>
                    </a>

                    <ul class="dropdown-menu">
                        <li><a class="deutsch"><img src="{{ asset('public/backend/assets/images/flags/de.png') }}"
                                    alt=""> Deutsch</a></li>
                        <li><a class="ukrainian"><img src="{{ asset('public/backend/assets/images/flags/ua.png') }}"
                                    alt=""> Українська</a></li>
                        <li><a class="english"><img src="{{ asset('public/backend/assets/images/flags/gb.png') }}"
                                    alt=""> English</a></li>
                        <li><a class="espana"><img src="{{ asset('public/backend/assets/images/flags/es.png') }}"
                                    alt=""> España</a></li>
                        <li><a class="russian"><img src="{{ asset('public/backend/assets/images/flags/ru.png') }}"
                                    alt=""> Русский</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-content width-350">
                        ...
                        <ul class="media-list dropdown-content-body">
                            <li class="media">
                                <div class="media-left">
                                    <img src="{{ asset('public/backend/assets/images/placeholder.jpg') }}"
                            ...
                            <li class="media">
                                <div class="media-left"><img
                                        src="{{ asset('public/backend/assets/images/placeholder.jpg') }}"
